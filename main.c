...
int menu(){
    ...
    printf("\nDigite 10 para criar arvores binárias em memoria interna e externa.");
    ...
    while(op!=-1){
        switch (op){
            ...
            case (4):
                nParticoes = 10;
                nElementos = 2;
                printf("\n\nA estrutura de interpolacao será composta por 10 arquivos de no máximo 2 elementos.\n");
            ...
            case (5):
                if(crioulistadenomes){
                    ...
                    prox = nomes;
                    criouparticoes=1;
                }else printf("Lista de nomes de arquivos inexistente para gerar partições, crie a estrutura de interpolacao utilizando a opção 4 do menu!!!\n");
                break;
            case (6):
                if(crioulistadenomes){
                    ...
                    prox = nomes;
                    criouparticoes=1;
                }else printf("Lista de nomes de arquivos inexistente para gerar particoes, crie a estrutura de interpolacao utilizando a opcao  4 do menu!!!\n");
                break;
           case (7):
                if(criouparticoes){
                    ...
                    crioupilhas = 1;
                    nomes = prox;
                }else printf("Particoes não foram criadas, crie as particoes utilizando as opcoes 5 ou 6  do menu!!!\n");
                break;
            case (8):
                if(criouparticoes){
                    printf("\n\nIntercalando as particoes, utilizando o método de intercalacao basico.\n");
                    ...
                    fclose(fi);
                }else printf("Particoes não foram criadas, crie as particoes utilizando as opções 5 ou 6 do menu!!!\n");
                break;
            case (9):
                ...
                if(criouparticoes){
                    ...
                    }else printf("As pilhas das particoes geradas não foram criadas, crie as pilhas utilizando as opcoes 7!!!\n");
                }else printf("Particoes não foram criadas, crie as particoes utilizando as opções 5 ou 6  do menu!!!\n");
